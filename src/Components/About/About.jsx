...
function About() {
  return (
    <>
    <div className="main1  w-auto md:w-[720px] lg:w-[855px] xl:w-[990px]  mt-8 ml-12 ">
            <h1 className="w-auto h-[44.8px] mb-10 text-[40px] font-sans font-bold text-amber-600">About Bethany's Pie Shop</h1>
            <p className="w-auto sm:w-[550px] md:w-[720px] lg:w-[831px] xl:w-[966px] h-[24px] mb-4 font-sans text-[16px]">In the video below, you can see how we create our pies.</p>
