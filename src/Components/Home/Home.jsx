...
function Home() {
  return (
    ...
    <div className="main1 w-auto md:w-[720px] lg:w-[855px] xl:w-[990px]  ml-2 text-wrap md:mt-8 md:ml-12 ">
      <h1 className="w-[479px] sm:w-[550px] md:w-[720px] lg:w-[831px] xl:w-[966px] h-[48px] md:mb-4 sm:mb-3 md:text-[40px] font-sans font-bold text-amber-600">Welcome to Bethany's Pie Shop</h1>
      ...
      <h2 className="md:text-[36px] font-bold mt-4 mb-2 w-[479px] sm:w-[550px] md:w-[720px] lg:w-[831px] xl:w-[966px] h-[38.4px]">Our History</h2>
